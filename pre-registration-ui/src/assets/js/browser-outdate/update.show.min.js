...
var $buo_show = function () {
    ...
    if (!ta.msg && t.indexOf && t.indexOf("%s") !== -1) {
        ...
        if (op.style === "bottom") style2 += "<style>.buorg { font-size: 12px; font-family: Roboto, \"Helvetica Neue\", sans-serif; bottom:0; top:auto; } @keyframes buorgfly {from {opacity:0;transform:translateY(50px)} to {opacity:1;transform:translateY(0px)}}</style>";
            ...
            style2 +=
                "<style> .buorg {font-family: Arial, Helvetica, Calibri, Arial, sans-serif; font-size: 13px;line-height: 1.5em; border-radius: 10px 10px; text-align: left; width:390px; height: 115px; bottom:50px; right:50px; left:auto; } .buorg-mainmsg, .buorg-moremsg { display: block; }   .buorg-icon {display: inline-block;} @media(max-width: 500px){.buorg {font-family: Arial, Helvetica, Calibri, Arial, sans-serif; font-size: 13px;line-height: 1.5em; border-radius: 10px 10px; text-align: left; width:300px; height: 115px; bottom:50px; right:50px; left:auto; } .buorg-mainmsg, .buorg-moremsg { display: block; } .buorg-icon {display: inline-block;}}</style>";
