...
export const APPEND_URL = {
  ...
  location: '/proxy/masterdata/',
  gender: '/proxy/masterdata/gendertypes',
  resident: '/proxy/masterdata/individualtypes',
  transliteration: 'transliteration/transliterate',
  //applicantType: 'v1/applicanttype/',
  applicantType: '/proxy/masterdata/',
